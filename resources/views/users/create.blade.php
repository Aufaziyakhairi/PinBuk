                ...
                <form method="POST" action="{{ route('users.store') }}" class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="password" name="password" id="password" required
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 @error('password') border-red-500 @enderror">
                        <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Minimal 8 karakter, harus mengandung huruf besar, angka, dan simbol</p>
                        @error('password')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                        <p class="text-sm text-blue-700 dark:text-blue-300">
                            <strong>ℹ️ Catatan:</strong> User akan dapat login dengan email dan password yang didaftarkan di sini.
                        </p>
                    </div>
